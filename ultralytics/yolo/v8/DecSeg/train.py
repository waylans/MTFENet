...
from ultralytics.yolo.utils.loss import BboxLoss, FocalLossV1, tversky,FocalLossV2
...
import itertools
from ultralytics.yolo.utils.metrics import bbox_iou, probiou, bbox_mpdiou, bbox_inner_iou, bbox_focaler_iou, bbox_inner_mpdiou, bbox_focaler_mpdiou, wasserstein_loss, WiseIouLoss
import math
...
class SegLoss(Loss):
    ...
    def __call__(self, preds, batch):
        ...
        ######  This code only for binary segmentation. To Do: add multi seg
